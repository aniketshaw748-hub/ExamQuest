...
export const SUBJECTS = [
  ...
  { key: "chemistry", name: "Chemistry", file: "data/chemistry.json", icon: Flask, world: "World VI", title: "The Reaction\nLab", blurb: "Atomic structure, spectroscopy, thermodynamics, electrochemistry and organic synthesis.", bespoke: true, video: { url: "https://www.youtube.com/playlist?list=PLM9E7EXMIP3i13N_8lljeiENTCxip7vIa", channel: "IAE Academy" } },
