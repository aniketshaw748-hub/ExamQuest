...
import { TEACH_BIOLOGY } from "../data/biology-teach.js";
...
const TEACH_BY_SUBJECT = { dmaths: TEACH, daa: TEACH_DAA, automata: TEACH_AUTOMATA, ca: TEACH_CA, chemistry: TEACH_CHEMISTRY, evs: TEACH_EVS, biology: TEACH_BIOLOGY };
