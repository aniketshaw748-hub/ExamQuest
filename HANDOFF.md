...
- **D.Maths Ch5–Ch6:** NOT STARTED (lessons use raw OCR prose fallback; no bespoke explainers; no curated walkthroughs). Data is fully parsed and waiting (ch5: 4 MCQ/12 short/17 long, ch6: 33/26/26).
