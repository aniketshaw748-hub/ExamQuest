...
- **All 6 subjects are present and playable** (multi-subject picker). D.Maths fully bespoke; DAA/Automata/CA/Chemistry/EVS run on the verified concept-lesson fallback + auto walkthroughs + MCQ/boss/AI-chatbot. Site builds clean and runs on localhost.
