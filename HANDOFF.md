...
- **FULL-ILLUSTRATION LOOP (2026-06-20, ongoing):** illustrating every lesson of every subject with a bespoke code-drawn interactive. **DONE: D.Maths (6/6), Automata (6/6), DAA (6/6), CA (6/6), Chemistry (11/11), EVS Ch1-2** (new `src/data/evs-teach.js`, key `evs`; Ch1 fundamentals `spheres`+`sustainability`, Ch2 ecology `foodchain`+`nutrientcycle`). ~93 explainers registered. **Remaining: EVS Ch3-7 only** (Air/Water/Land/Noise pollution + Environmental Management — still on the verified concept-lesson fallback). After EVS Ch7 the whole site is fully illustrated.
